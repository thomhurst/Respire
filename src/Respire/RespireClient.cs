...
public sealed partial class RespireClient : IRespireClient
{
    ...
    /// <summary>
    /// Connects using a connection string: "host", "host:port", a StackExchange.Redis-compatible
    /// comma-delimited string, or a <c>redis://[user[:password]@]host[:port][/db]</c> URI
