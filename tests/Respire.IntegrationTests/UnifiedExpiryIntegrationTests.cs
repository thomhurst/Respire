...
public class UnifiedExpiryIntegrationTests(ModernRedisTestContainer fixture)
{
    ...
    public async Task StringGetAndExpire_UpdatesAndRemovesExpiry()
    {
        ...
        (await client.Strings.GetAndExpireAsync("unified:string", RespireExpiry.Persist)).Should().Be("value");
    ...
    public async Task HashExpiry_UsesRelativeAbsolutePersistAndKeepForms()
    {
        ...
        (await client.Hashes.GetAndExpireAsync(
        ...
        (await client.Hashes.GetAndExpireAsync("unified:hash", RespireExpiry.Persist, "field"))
